...
public class PatientEncounterController implements Serializable {
    ...
    List<ItemUsage> currentPatientTreatments;
    ...
    ItemUsage currentPatientTreatment;
    ItemUsage removingPatientTreatment;
    ...
    public void addPatientTreatment(){
        if(currentPatient==null ){
            JsfUtil.addSuccessMessage("Select Patient");
            return;
        }
        currentPatientTreatment.setType(ItemUsageType.PatientItems);
        currentPatientTreatment.setPatient(currentPatient);
        currentPatientTreatment.setCreatedAt(new Date());
        currentPatientTreatment.setCreater(sessionController.getLoggedUser());
        itemUsageFacade.create(currentPatientTreatment);
    }
    ...
    public ItemUsage getCurrentPatientTreatment() {
        if(currentPatientTreatment==null){
            currentPatientTreatment = new ItemUsage();
        }
        return currentPatientTreatment;
    }

    public void setCurrentPatientTreatment(ItemUsage currentPatientTreatment) {
        this.currentPatientTreatment = currentPatientTreatment;
    }
    ...
    public List<ItemUsage> getCurrentPatientTreatments() {
        return currentPatientTreatments;
    }

    public void setCurrentPatientTreatments(List<ItemUsage> currentPatientTreatments) {
        this.currentPatientTreatments = currentPatientTreatments;
    }
    ...
    public List<ItemUsage> fillCurrentPatientAllergies(Patient patient) {
        Map m = new HashMap();
        m.put("p", patient);
    ...
    public List<ItemUsage> fillCurrentPatientTreatments(Patient patient) {
        Map m = new HashMap();
        m.put("p", patient);
        m.put("t", ItemUsageType.PatientItems);
        String sql;
        sql = "Select e "
                + " from ItemUsage e "
                + " where e.patient=:p "
    ...
    public void fillCurrentPatientLists(Patient patient) {
        ...
        currentPatientAllergies = fillCurrentPatientAllergies(patient);
        currentPatientTreatments = fillCurrentPatientTreatments(patient);
...
//        getPharmacySaleController().getBill().setPatient(current.getPatient());
    ...
    public ItemUsage getRemovingPatientTreatment() {
        return removingPatientTreatment;
    }

    public void setRemovingPatientTreatment(ItemUsage removingPatientTreatment) {
        this.removingPatientTreatment = removingPatientTreatment;
    }
